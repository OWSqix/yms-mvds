...
public class Prop {
    ...
    public class Edc {
        ...
        public final String URL = CTX + "url";
        public final String ALLOWED_SOURCE_TYPES = CTX + "allowedSourceTypes";
        public final String ALLOWED_DEST_TYPES = CTX + "allowedDestTypes";
        public final String ALLOWED_TRANSFER_TYPES = CTX + "allowedTransferTypes";
        public final String PUBLIC_API_URL = CTX + "publicApiUrl";
    }
