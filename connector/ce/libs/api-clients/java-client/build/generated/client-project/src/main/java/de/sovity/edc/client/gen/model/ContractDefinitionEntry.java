...
public class ContractDefinitionEntry {
  ...
  @javax.annotation.Nonnull
  private List<UiCriterion> assetSelector = new ArrayList<>();
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContractDefinitionEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<ContractDefinitionEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContractDefinitionEntry.class));
