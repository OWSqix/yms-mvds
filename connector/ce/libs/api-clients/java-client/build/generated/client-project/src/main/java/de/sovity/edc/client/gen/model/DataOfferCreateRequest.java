...
public class DataOfferCreateRequest {
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Policy Expression. Only relevant if policyType is 'RESTRICTED'")
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataOfferCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<DataOfferCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DataOfferCreateRequest.class));
