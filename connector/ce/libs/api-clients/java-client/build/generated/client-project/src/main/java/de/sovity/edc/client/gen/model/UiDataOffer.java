...
public class UiDataOffer {
  ...
  @javax.annotation.Nonnull
  private List<UiContractOffer> contractOffers = new ArrayList<>();
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UiDataOffer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<UiDataOffer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UiDataOffer.class));
