...
public class ContractDefinitionPage {
  ...
  private List<ContractDefinitionEntry> contractDefinitions = new ArrayList<>();
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContractDefinitionPage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<ContractDefinitionPage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContractDefinitionPage.class));
