...
public class TransferProcessStatesDto {
  ...
  private Map<String, Long> incomingTransferProcessCounts = new HashMap<>();
  ...
  @javax.annotation.Nonnull
  private Map<String, Long> outgoingTransferProcessCounts = new HashMap<>();
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransferProcessStatesDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<TransferProcessStatesDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransferProcessStatesDto.class));
