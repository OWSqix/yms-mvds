...
public class UiAssetEditRequest {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UiAssetEditRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<UiAssetEditRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UiAssetEditRequest.class));
