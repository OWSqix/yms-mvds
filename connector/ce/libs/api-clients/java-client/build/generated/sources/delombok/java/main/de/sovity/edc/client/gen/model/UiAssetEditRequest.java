 ...
 */
@ApiModel(description = "Type-safe data offer metadata for editing an asset as supported by the sovity product landscape. Contains extension points.")
@SuppressWarnings("all")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class UiAssetEditRequest {
  public static final String SERIALIZED_NAME_DATA_SOURCE_OVERRIDE_OR_NULL = "dataSourceOverrideOrNull";
  @SerializedName(SERIALIZED_NAME_DATA_SOURCE_OVERRIDE_OR_NULL)
  ...
  public UiAssetEditRequest dataSourceOverrideOrNull(@javax.annotation.Nullable UiDataSource dataSourceOverrideOrNull) {
  ...
  /**
   * Data Source
   * @return dataSourceOverrideOrNull
   */
  @javax.annotation.Nullable
  ...
  public void setDataSourceOverrideOrNull(@javax.annotation.Nullable UiDataSource dataSourceOverrideOrNull) {
    this.dataSourceOverrideOrNull = dataSourceOverrideOrNull;
  }

  public UiAssetEditRequest title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public UiAssetEditRequest language(@javax.annotation.Nullable String language) {
  ...
  public UiAssetEditRequest description(@javax.annotation.Nullable String description) {
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty("Asset Description")
  ...
  public UiAssetEditRequest publisherHomepage(@javax.annotation.Nullable String publisherHomepage) {
  ...
  public UiAssetEditRequest licenseUrl(@javax.annotation.Nullable String licenseUrl) {
  ...
  public UiAssetEditRequest version(@javax.annotation.Nullable String version) {
  ...
  public UiAssetEditRequest keywords(@javax.annotation.Nullable List<String> keywords) {
    this.keywords = keywords;
    return this;
  }

  public UiAssetEditRequest addKeywordsItem(String keywordsItem) {
  ...
  public UiAssetEditRequest mediaType(@javax.annotation.Nullable String mediaType) {
  ...
  public UiAssetEditRequest landingPageUrl(@javax.annotation.Nullable String landingPageUrl) {
  ...
  public UiAssetEditRequest dataCategory(@javax.annotation.Nullable String dataCategory) {
  ...
  public UiAssetEditRequest dataSubcategory(@javax.annotation.Nullable String dataSubcategory) {
  ...
  public UiAssetEditRequest dataModel(@javax.annotation.Nullable String dataModel) {
  ...
  public UiAssetEditRequest geoReferenceMethod(@javax.annotation.Nullable String geoReferenceMethod) {
  ...
  public UiAssetEditRequest transportMode(@javax.annotation.Nullable String transportMode) {
  ...
  public UiAssetEditRequest sovereignLegalName(@javax.annotation.Nullable String sovereignLegalName) {
  ...
  public UiAssetEditRequest geoLocation(@javax.annotation.Nullable String geoLocation) {
  ...
  public UiAssetEditRequest nutsLocations(@javax.annotation.Nullable List<String> nutsLocations) {
    this.nutsLocations = nutsLocations;
    return this;
  }

  public UiAssetEditRequest addNutsLocationsItem(String nutsLocationsItem) {
  ...
  public UiAssetEditRequest dataSampleUrls(@javax.annotation.Nullable List<String> dataSampleUrls) {
    this.dataSampleUrls = dataSampleUrls;
    return this;
  }

  public UiAssetEditRequest addDataSampleUrlsItem(String dataSampleUrlsItem) {
  ...
  public UiAssetEditRequest referenceFileUrls(@javax.annotation.Nullable List<String> referenceFileUrls) {
    this.referenceFileUrls = referenceFileUrls;
    return this;
  }

  public UiAssetEditRequest addReferenceFileUrlsItem(String referenceFileUrlsItem) {
  ...
  public UiAssetEditRequest referenceFilesDescription(@javax.annotation.Nullable String referenceFilesDescription) {
  ...
  public UiAssetEditRequest conditionsForUse(@javax.annotation.Nullable String conditionsForUse) {
  ...
  public UiAssetEditRequest dataUpdateFrequency(@javax.annotation.Nullable String dataUpdateFrequency) {
  ...
  public UiAssetEditRequest temporalCoverageFrom(@javax.annotation.Nullable LocalDate temporalCoverageFrom) {
  ...
  public UiAssetEditRequest temporalCoverageToInclusive(@javax.annotation.Nullable LocalDate temporalCoverageToInclusive) {
  ...
  public UiAssetEditRequest customJsonAsString(@javax.annotation.Nullable String customJsonAsString) {
  ...
  public UiAssetEditRequest customJsonLdAsString(@javax.annotation.Nullable String customJsonLdAsString) {
  ...
  public UiAssetEditRequest privateCustomJsonAsString(@javax.annotation.Nullable String privateCustomJsonAsString) {
  ...
  public UiAssetEditRequest privateCustomJsonLdAsString(@javax.annotation.Nullable String privateCustomJsonLdAsString) {
  ...
  public String toString() {
    ...
    sb.append("class UiAssetEditRequest {\n");
    sb.append("    dataSourceOverrideOrNull: ").append(toIndentedString(dataSourceOverrideOrNull)).append("\n");
  ...
  static {
    ...
    openapiFields.add("dataSourceOverrideOrNull");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UiAssetEditRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!UiAssetEditRequest.openapiRequiredFields.isEmpty()) {
        // has required fields but JSON element is null
        throw new IllegalArgumentException(String.format("The required field(s) %s in UiAssetEditRequest is not found in the empty JSON string", UiAssetEditRequest.openapiRequiredFields.toString()));
      }
    }
    Set<Map.Entry<String, JsonElement>> entries = jsonElement.getAsJsonObject().entrySet();
    // check to see if the JSON string contains additional fields
    for (Map.Entry<String, JsonElement> entry : entries) {
      if (!UiAssetEditRequest.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UiAssetEditRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
      }
    }
    JsonObject jsonObj = jsonElement.getAsJsonObject();
    // validate the optional field `dataSourceOverrideOrNull`
    if (jsonObj.get("dataSourceOverrideOrNull") != null && !jsonObj.get("dataSourceOverrideOrNull").isJsonNull()) {
      UiDataSource.validateJsonElement(jsonObj.get("dataSourceOverrideOrNull"));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!UiAssetEditRequest.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'UiAssetEditRequest' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<UiAssetEditRequest> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(UiAssetEditRequest.class));
      return (TypeAdapter<T>) new TypeAdapter<UiAssetEditRequest>() {
        @Override
        public void write(JsonWriter out, UiAssetEditRequest value) throws IOException {
          JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
          elementAdapter.write(out, obj);
        }
        @Override
        public UiAssetEditRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UiAssetEditRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UiAssetEditRequest
   * @throws IOException if the JSON string is invalid with respect to UiAssetEditRequest
   */
  public static UiAssetEditRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UiAssetEditRequest.class);
  }

  /**
   * Convert an instance of UiAssetEditRequest to an JSON string
   *
   * @return JSON string
   */
  ...
  public static class UiAssetEditRequestBuilder {
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder dataSourceOverrideOrNull(@javax.annotation.Nullable final UiDataSource dataSourceOverrideOrNull) {
      this.dataSourceOverrideOrNull = dataSourceOverrideOrNull;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder title(@javax.annotation.Nullable final String title) {
      this.title = title;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder language(@javax.annotation.Nullable final String language) {
      this.language = language;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder description(@javax.annotation.Nullable final String description) {
      this.description = description;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder publisherHomepage(@javax.annotation.Nullable final String publisherHomepage) {
      this.publisherHomepage = publisherHomepage;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder licenseUrl(@javax.annotation.Nullable final String licenseUrl) {
      this.licenseUrl = licenseUrl;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder version(@javax.annotation.Nullable final String version) {
      this.version = version;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder keywords(@javax.annotation.Nullable final List<String> keywords) {
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder mediaType(@javax.annotation.Nullable final String mediaType) {
      this.mediaType = mediaType;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder landingPageUrl(@javax.annotation.Nullable final String landingPageUrl) {
      this.landingPageUrl = landingPageUrl;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder dataCategory(@javax.annotation.Nullable final String dataCategory) {
      this.dataCategory = dataCategory;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder dataSubcategory(@javax.annotation.Nullable final String dataSubcategory) {
      this.dataSubcategory = dataSubcategory;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder dataModel(@javax.annotation.Nullable final String dataModel) {
      this.dataModel = dataModel;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder geoReferenceMethod(@javax.annotation.Nullable final String geoReferenceMethod) {
      this.geoReferenceMethod = geoReferenceMethod;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder transportMode(@javax.annotation.Nullable final String transportMode) {
      this.transportMode = transportMode;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder sovereignLegalName(@javax.annotation.Nullable final String sovereignLegalName) {
      this.sovereignLegalName = sovereignLegalName;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder geoLocation(@javax.annotation.Nullable final String geoLocation) {
      this.geoLocation = geoLocation;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder nutsLocations(@javax.annotation.Nullable final List<String> nutsLocations) {
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder dataSampleUrls(@javax.annotation.Nullable final List<String> dataSampleUrls) {
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder referenceFileUrls(@javax.annotation.Nullable final List<String> referenceFileUrls) {
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder referenceFilesDescription(@javax.annotation.Nullable final String referenceFilesDescription) {
      this.referenceFilesDescription = referenceFilesDescription;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder conditionsForUse(@javax.annotation.Nullable final String conditionsForUse) {
      this.conditionsForUse = conditionsForUse;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder dataUpdateFrequency(@javax.annotation.Nullable final String dataUpdateFrequency) {
      this.dataUpdateFrequency = dataUpdateFrequency;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder temporalCoverageFrom(@javax.annotation.Nullable final LocalDate temporalCoverageFrom) {
      this.temporalCoverageFrom = temporalCoverageFrom;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder temporalCoverageToInclusive(@javax.annotation.Nullable final LocalDate temporalCoverageToInclusive) {
      this.temporalCoverageToInclusive = temporalCoverageToInclusive;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder customJsonAsString(@javax.annotation.Nullable final String customJsonAsString) {
      this.customJsonAsString = customJsonAsString;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder customJsonLdAsString(@javax.annotation.Nullable final String customJsonLdAsString) {
      this.customJsonLdAsString = customJsonLdAsString;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder privateCustomJsonAsString(@javax.annotation.Nullable final String privateCustomJsonAsString) {
      this.privateCustomJsonAsString = privateCustomJsonAsString;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiAssetEditRequest.UiAssetEditRequestBuilder privateCustomJsonLdAsString(@javax.annotation.Nullable final String privateCustomJsonLdAsString) {
      this.privateCustomJsonLdAsString = privateCustomJsonLdAsString;
      return this;
    }
