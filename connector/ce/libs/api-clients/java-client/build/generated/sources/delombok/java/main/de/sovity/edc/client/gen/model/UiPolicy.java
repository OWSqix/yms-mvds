...
public class UiPolicy {
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty("Policy expression")
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!UiPolicy.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<UiPolicy> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(UiPolicy.class));
  ...
  public static class UiPolicyBuilder {
     ...
     * @return {@code this}.
     */
    public UiPolicy.UiPolicyBuilder policyJsonLd(@javax.annotation.Nonnull final String policyJsonLd) {
     ...
     * @return {@code this}.
     */
    public UiPolicy.UiPolicyBuilder expression(@javax.annotation.Nullable final UiPolicyExpression expression) {
      this.expression = expression;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiPolicy.UiPolicyBuilder errors(@javax.annotation.Nonnull final List<String> errors) {
      if (errors == null) {
    ...
    public UiPolicy build() {
      List<String> errors$value = this.errors$value;
      if (!this.errors$set) errors$value = UiPolicy.$default$errors();
      return new UiPolicy(this.policyJsonLd, this.expression, errors$value);
    }

    @Override
    public String toString() {
      return "UiPolicy.UiPolicyBuilder(policyJsonLd=" + this.policyJsonLd + ", expression=" + this.expression + ", errors$value=" + this.errors$value + ")";
    }
  }
  ...
  public UiPolicy(@javax.annotation.Nonnull final String policyJsonLd, @javax.annotation.Nullable final UiPolicyExpression expression, @javax.annotation.Nonnull final List<String> errors) {
    if (policyJsonLd == null) {
      throw new NullPointerException("policyJsonLd is marked non-null but is null");
    }
    if (errors == null) {
