...
public class ContractAgreementPageQuery {
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty("Optionally filter the resulting contract agreements by their termination status.")
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!ContractAgreementPageQuery.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<ContractAgreementPageQuery> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(ContractAgreementPageQuery.class));
  ...
  public static class ContractAgreementPageQueryBuilder {
    private ContractTerminationStatus terminationStatus;

    ContractAgreementPageQueryBuilder() {
    }

    /**
     * @return {@code this}.
     */
    public ContractAgreementPageQuery.ContractAgreementPageQueryBuilder terminationStatus(@javax.annotation.Nullable final ContractTerminationStatus terminationStatus) {
      this.terminationStatus = terminationStatus;
      return this;
    }

    public ContractAgreementPageQuery build() {
      return new ContractAgreementPageQuery(this.terminationStatus);
    }

    @Override
    public String toString() {
      return "ContractAgreementPageQuery.ContractAgreementPageQueryBuilder(terminationStatus=" + this.terminationStatus + ")";
    }
  }

  public static ContractAgreementPageQuery.ContractAgreementPageQueryBuilder builder() {
    return new ContractAgreementPageQuery.ContractAgreementPageQueryBuilder();
  }

  public ContractAgreementPageQuery(@javax.annotation.Nullable final ContractTerminationStatus terminationStatus) {
    this.terminationStatus = terminationStatus;
  }
}
