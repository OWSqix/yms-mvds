...
public class PolicyDefinitionPage {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PolicyDefinitionPage.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<PolicyDefinitionPage> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(PolicyDefinitionPage.class));
  ...
  private static List<PolicyDefinitionDto> $default$policies() {
    return new ArrayList<>();
  }


  public static class PolicyDefinitionPageBuilder {
    private boolean policies$set;
    private List<PolicyDefinitionDto> policies$value;
     ...
     * @return {@code this}.
     */
    public PolicyDefinitionPage.PolicyDefinitionPageBuilder policies(@javax.annotation.Nonnull final List<PolicyDefinitionDto> policies) {
      if (policies == null) {
    ...
    public PolicyDefinitionPage build() {
      List<PolicyDefinitionDto> policies$value = this.policies$value;
      if (!this.policies$set) policies$value = PolicyDefinitionPage.$default$policies();
      return new PolicyDefinitionPage(policies$value);
    }

    @Override
    public String toString() {
      return "PolicyDefinitionPage.PolicyDefinitionPageBuilder(policies$value=" + this.policies$value + ")";
    }
  }
  ...
  public PolicyDefinitionPage(@javax.annotation.Nonnull final List<PolicyDefinitionDto> policies) {
    if (policies == null) {
      throw new NullPointerException("policies is marked non-null but is null");
    }
    this.policies = policies;
