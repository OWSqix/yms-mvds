...
public class DashboardPage {
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Your Connector's DAPS Configuration (if present)")
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Your Connector's Catena-X Web-DID Configuration (if present)")
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DashboardPage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<DashboardPage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DashboardPage.class));
