...
public class UiDataSource {
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Only for type HTTP_DATA")
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Only for type ON_REQUEST")
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty(value = "For all types. Custom Data Address Properties.")
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UiDataSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<UiDataSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UiDataSource.class));
