...
public class PolicyDefinitionCreateRequest {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!PolicyDefinitionCreateRequest.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<PolicyDefinitionCreateRequest> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(PolicyDefinitionCreateRequest.class));
  ...
  public static class PolicyDefinitionCreateRequestBuilder {
     ...
     * @return {@code this}.
     */
    public PolicyDefinitionCreateRequest.PolicyDefinitionCreateRequestBuilder policyDefinitionId(@javax.annotation.Nonnull final String policyDefinitionId) {
     ...
     */
    @Deprecated
    public PolicyDefinitionCreateRequest.PolicyDefinitionCreateRequestBuilder policy(@javax.annotation.Nonnull final UiPolicyCreateRequest policy) {
      if (policy == null) {
  ...
  public PolicyDefinitionCreateRequest(@javax.annotation.Nonnull final String policyDefinitionId, @javax.annotation.Nonnull final UiPolicyCreateRequest policy) {
    if (policyDefinitionId == null) {
      throw new NullPointerException("policyDefinitionId is marked non-null but is null");
    }
    if (policy == null) {
