...
public class SecretValue {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SecretValue.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<SecretValue> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(SecretValue.class));
  ...
  public static class SecretValueBuilder {
     ...
     * @return {@code this}.
     */
    public SecretValue.SecretValueBuilder secretName(@javax.annotation.Nullable final String secretName) {
      this.secretName = secretName;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public SecretValue.SecretValueBuilder rawValue(@javax.annotation.Nullable final String rawValue) {
      this.rawValue = rawValue;
      return this;
    }
  ...
  public SecretValue(@javax.annotation.Nullable final String secretName, @javax.annotation.Nullable final String rawValue) {
    this.secretName = secretName;
    this.rawValue = rawValue;
  }
}
