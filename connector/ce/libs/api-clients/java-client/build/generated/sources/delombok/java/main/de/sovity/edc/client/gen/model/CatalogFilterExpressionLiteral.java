...
public class CatalogFilterExpressionLiteral {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CatalogFilterExpressionLiteral.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CatalogFilterExpressionLiteral> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(CatalogFilterExpressionLiteral.class));
  ...
  public static class CatalogFilterExpressionLiteralBuilder {
     ...
     * @return {@code this}.
     */
    public CatalogFilterExpressionLiteral.CatalogFilterExpressionLiteralBuilder type(@javax.annotation.Nullable final CatalogFilterExpressionLiteralType type) {
      this.type = type;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public CatalogFilterExpressionLiteral.CatalogFilterExpressionLiteralBuilder value(@javax.annotation.Nullable final String value) {
      this.value = value;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public CatalogFilterExpressionLiteral.CatalogFilterExpressionLiteralBuilder valueList(@javax.annotation.Nullable final List<String> valueList) {
    ...
    public CatalogFilterExpressionLiteral build() {
      ...
      if (!this.valueList$set) valueList$value = CatalogFilterExpressionLiteral.$default$valueList();
      return new CatalogFilterExpressionLiteral(this.type, this.value, valueList$value);
    }

    @Override
    public String toString() {
      return "CatalogFilterExpressionLiteral.CatalogFilterExpressionLiteralBuilder(type=" + this.type + ", value=" + this.value + ", valueList$value=" + this.valueList$value + ")";
    }
  }
  ...
  public CatalogFilterExpressionLiteral(@javax.annotation.Nullable final CatalogFilterExpressionLiteralType type, @javax.annotation.Nullable final String value, @javax.annotation.Nullable final List<String> valueList) {
    this.type = type;
    this.value = value;
    this.valueList = valueList;
  }
