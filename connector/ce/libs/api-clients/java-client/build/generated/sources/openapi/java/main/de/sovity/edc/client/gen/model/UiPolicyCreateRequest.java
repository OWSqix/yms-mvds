...
public class UiPolicyCreateRequest {
  ...
  private List<UiPolicyConstraint> constraints  =  new ArrayList<>();
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Conjunction of required constraints")
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UiPolicyCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<UiPolicyCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UiPolicyCreateRequest.class));
