...
public class CatalogQuery {
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty("Target EDC Participant ID. It is required if the connector endpoint does not contain the queryParam \'participantId\'.")
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty("Limit the number of results")
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty("Offset for returned results, e.g. start at result 2")
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty("Filter expressions for catalog filtering")
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!CatalogQuery.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<CatalogQuery> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(CatalogQuery.class));
  ...
  private static List<CatalogFilterExpression> $default$filterExpressions() {
  ...
  public static class CatalogQueryBuilder {
    ...
    private Integer limit;
    private Integer offset;
    private boolean filterExpressions$set;
    private List<CatalogFilterExpression> filterExpressions$value;
     ...
     * @return {@code this}.
     */
    public CatalogQuery.CatalogQueryBuilder connectorEndpoint(@javax.annotation.Nonnull final String connectorEndpoint) {
     ...
     * @return {@code this}.
     */
    public CatalogQuery.CatalogQueryBuilder participantId(@javax.annotation.Nullable final String participantId) {
      this.participantId = participantId;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public CatalogQuery.CatalogQueryBuilder limit(@javax.annotation.Nullable final Integer limit) {
      this.limit = limit;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public CatalogQuery.CatalogQueryBuilder offset(@javax.annotation.Nullable final Integer offset) {
      this.offset = offset;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public CatalogQuery.CatalogQueryBuilder filterExpressions(@javax.annotation.Nullable final List<CatalogFilterExpression> filterExpressions) {
      this.filterExpressions$value = filterExpressions;
      filterExpressions$set = true;
      return this;
    }

    public CatalogQuery build() {
      List<CatalogFilterExpression> filterExpressions$value = this.filterExpressions$value;
      if (!this.filterExpressions$set) filterExpressions$value = CatalogQuery.$default$filterExpressions();
      return new CatalogQuery(this.connectorEndpoint, this.participantId, this.limit, this.offset, filterExpressions$value);
    }

    @Override
    public String toString() {
      return "CatalogQuery.CatalogQueryBuilder(connectorEndpoint=" + this.connectorEndpoint + ", participantId=" + this.participantId + ", limit=" + this.limit + ", offset=" + this.offset + ", filterExpressions$value=" + this.filterExpressions$value + ")";
    }
  }
  ...
  public CatalogQuery(@javax.annotation.Nonnull final String connectorEndpoint, @javax.annotation.Nullable final String participantId, @javax.annotation.Nullable final Integer limit, @javax.annotation.Nullable final Integer offset, @javax.annotation.Nullable final List<CatalogFilterExpression> filterExpressions) {
    if (connectorEndpoint == null) {
      throw new NullPointerException("connectorEndpoint is marked non-null but is null");
    }
    this.connectorEndpoint = connectorEndpoint;
