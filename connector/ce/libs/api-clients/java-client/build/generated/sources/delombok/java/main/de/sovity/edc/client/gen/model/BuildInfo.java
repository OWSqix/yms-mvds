...
public class BuildInfo {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!BuildInfo.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<BuildInfo> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(BuildInfo.class));
  ...
  public static class BuildInfoBuilder {
     ...
     * @return {@code this}.
     */
    public BuildInfo.BuildInfoBuilder buildDate(@javax.annotation.Nonnull final String buildDate) {
      if (buildDate == null) {
        throw new NullPointerException("buildDate is marked non-null but is null");
      }
      this.buildDate = buildDate;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public BuildInfo.BuildInfoBuilder buildVersion(@javax.annotation.Nonnull final String buildVersion) {
      if (buildVersion == null) {
        throw new NullPointerException("buildVersion is marked non-null but is null");
      }
      this.buildVersion = buildVersion;
      return this;
    }
  ...
  public BuildInfo(@javax.annotation.Nonnull final String buildDate, @javax.annotation.Nonnull final String buildVersion) {
    if (buildDate == null) {
      throw new NullPointerException("buildDate is marked non-null but is null");
    }
    if (buildVersion == null) {
