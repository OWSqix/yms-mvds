...
public class AssetPage {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!AssetPage.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<AssetPage> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(AssetPage.class));
  ...
  private static List<UiAsset> $default$assets() {
  ...
  public static class AssetPageBuilder {
    ...
    private List<UiAsset> assets$value;
     ...
     * @return {@code this}.
     */
    public AssetPage.AssetPageBuilder assets(@javax.annotation.Nonnull final List<UiAsset> assets) {
      if (assets == null) {
    ...
    public AssetPage build() {
      List<UiAsset> assets$value = this.assets$value;
      if (!this.assets$set) assets$value = AssetPage.$default$assets();
      return new AssetPage(assets$value);
    }

    @Override
    public String toString() {
      return "AssetPage.AssetPageBuilder(assets$value=" + this.assets$value + ")";
    }
  }
  ...
  public AssetPage(@javax.annotation.Nonnull final List<UiAsset> assets) {
    if (assets == null) {
      throw new NullPointerException("assets is marked non-null but is null");
    }
    this.assets = assets;
