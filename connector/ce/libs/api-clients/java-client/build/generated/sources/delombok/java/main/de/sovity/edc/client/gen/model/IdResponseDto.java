...
public class IdResponseDto {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!IdResponseDto.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<IdResponseDto> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(IdResponseDto.class));
  ...
  public static class IdResponseDtoBuilder {
     ...
     * @return {@code this}.
     */
    public IdResponseDto.IdResponseDtoBuilder id(@javax.annotation.Nonnull final String id) {
      if (id == null) {
     ...
     * @return {@code this}.
     */
    public IdResponseDto.IdResponseDtoBuilder lastUpdatedDate(@javax.annotation.Nonnull final OffsetDateTime lastUpdatedDate) {
    ...
    public IdResponseDto build() {
      return new IdResponseDto(this.id, this.lastUpdatedDate);
    }

    @Override
    public String toString() {
      return "IdResponseDto.IdResponseDtoBuilder(id=" + this.id + ", lastUpdatedDate=" + this.lastUpdatedDate + ")";
    }
  }
  ...
  public IdResponseDto(@javax.annotation.Nonnull final String id, @javax.annotation.Nonnull final OffsetDateTime lastUpdatedDate) {
    if (id == null) {
      throw new NullPointerException("id is marked non-null but is null");
    }
    if (lastUpdatedDate == null) {
