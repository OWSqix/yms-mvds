...
public class UiPolicyExpression {
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty("Only for types AND, OR, XONE. List of sub-expressions to be evaluated according to the expressionType.")
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty("Only for type CONSTRAINT. A single constraint.")
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!UiPolicyExpression.openapiRequiredFields.isEmpty()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<UiPolicyExpression> thisAdapter = gson.getDelegateAdapter(this, TypeToken.get(UiPolicyExpression.class));
  ...
  private static List<UiPolicyExpression> $default$expressions() {
  ...
  public static class UiPolicyExpressionBuilder {
    ...
    private List<UiPolicyExpression> expressions$value;
    private UiPolicyConstraint constraint;
     ...
     * @return {@code this}.
     */
    public UiPolicyExpression.UiPolicyExpressionBuilder type(@javax.annotation.Nonnull final UiPolicyExpressionType type) {
      if (type == null) {
     ...
     * @return {@code this}.
     */
    public UiPolicyExpression.UiPolicyExpressionBuilder expressions(@javax.annotation.Nullable final List<UiPolicyExpression> expressions) {
      this.expressions$value = expressions;
      expressions$set = true;
      return this;
    }
     ...
     * @return {@code this}.
     */
    public UiPolicyExpression.UiPolicyExpressionBuilder constraint(@javax.annotation.Nullable final UiPolicyConstraint constraint) {
      this.constraint = constraint;
      return this;
    }

    public UiPolicyExpression build() {
      List<UiPolicyExpression> expressions$value = this.expressions$value;
      if (!this.expressions$set) expressions$value = UiPolicyExpression.$default$expressions();
      return new UiPolicyExpression(this.type, expressions$value, this.constraint);
    }

    @Override
    public String toString() {
      return "UiPolicyExpression.UiPolicyExpressionBuilder(type=" + this.type + ", expressions$value=" + this.expressions$value + ", constraint=" + this.constraint + ")";
    }
  }
  ...
  public UiPolicyExpression(@javax.annotation.Nonnull final UiPolicyExpressionType type, @javax.annotation.Nullable final List<UiPolicyExpression> expressions, @javax.annotation.Nullable final UiPolicyConstraint constraint) {
    if (type == null) {
      throw new NullPointerException("type is marked non-null but is null");
    }
    this.type = type;
